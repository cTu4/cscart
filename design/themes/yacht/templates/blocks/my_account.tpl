...
<div id="account_info_{$block.snapping_id}">
    ...
    <ul class="ty-account-info">
        {hook name="profiles:my_account_menu"}
            ...
            {/capture}
            {if $auth.user_id}
                <li class="ty-account-info__item  ty-account-info__name ty-dropdown-box__item">{__('trips')}</li>
                <li class="ty-account-info__item  ty-account-info__name ty-dropdown-box__item">{__('messages')}</li>
                <li class="ty-account-info__item  ty-account-info__name ty-dropdown-box__item">{__('saved')}</li>
                ...
                <li class="ty-account-info__item  ty-account-info__name ty-dropdown-box__item">{__('hosts_community')}</li>

                <li class="ty-account-info__item  ty-account-info__name ty-dropdown-box__item">{__('services')}</li>
