<?php /* Smarty version Smarty-3.1.21, created on 2020-10-26 21:44:06
         compiled from "C:\OpenServer\domains\cscart\design\themes\responsive\templates\blocks\topmenu_dropdown.tpl" */ ?>
<?php /*%%SmartyHeaderCode:12000607615f9718f688fcc1-33926225%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'c174fd6e07c99c24de79cccf98a81806808f2b8a' => 
    array (
      0 => 'C:\\OpenServer\\domains\\cscart\\design\\themes\\responsive\\templates\\blocks\\topmenu_dropdown.tpl',
      1 => 1603732556,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '12000607615f9718f688fcc1-33926225',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5f9718f6931893_40059153',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5f9718f6931893_40059153')) {function content_5f9718f6931893_40059153($_smarty_tpl) {?><?php if (!is_callable('smarty_block_hook')) include 'C:/OpenServer/domains/cscart/app/functions/smarty_plugins\\block.hook.php';
...
?>
            ...
            <?php }?>
            <li class="ty-menu__item<?php if (!$_smarty_tpl->tpl_vars['item1']->value[$_smarty_tpl->tpl_vars['childs']->value]) {?> ty-menu__item-nodrop<?php } else { ?> cm-menu-item-responsive<?php }
...
"<?php }?> <?php if ($_smarty_tpl->tpl_vars['item2']->value['new_window']) {?>target="_blank"<?php }?>><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['item2']->value[$_smarty_tpl->tpl_vars['name']->value], ENT_QUOTES, 'UTF-8');?>
</a>
                                    </li>
                                <?php } ?>
...
"<?php }?> class="ty-menu__submenu-link" <?php if ($_smarty_tpl->tpl_vars['item2']->value['new_window']) {?>target="_blank"<?php }?>><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['item2']->value[$_smarty_tpl->tpl_vars['name']->value], ENT_QUOTES, 'UTF-8');?>
</a>
                                            </div>
...
"<?php }?>
                                                                        class="ty-menu__submenu-link" <?php if ($_smarty_tpl->tpl_vars['item3']->value['new_window']) {?>target="_blank"<?php }?>><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['item3']->value[$_smarty_tpl->tpl_vars['name']->value], ENT_QUOTES, 'UTF-8');?>
</a>
                                                            </li>
                                                        <?php } ?>
