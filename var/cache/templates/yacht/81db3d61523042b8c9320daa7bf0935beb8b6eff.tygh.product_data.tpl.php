<?php /* Smarty version Smarty-3.1.21, created on 2020-10-26 21:44:11
         compiled from "C:\OpenServer\domains\cscart\design\themes\responsive\templates\common\product_data.tpl" */ ?>
<?php /*%%SmartyHeaderCode:5634557115f9718fb51e733-02276670%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '81db3d61523042b8c9320daa7bf0935beb8b6eff' => 
    array (
      0 => 'C:\\OpenServer\\domains\\cscart\\design\\themes\\responsive\\templates\\common\\product_data.tpl',
      1 => 1603732556,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '5634557115f9718fb51e733-02276670',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5f9718fb95d1e8_92722883',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5f9718fb95d1e8_92722883')) {function content_5f9718fb95d1e8_92722883($_smarty_tpl) {?><?php if (!is_callable('smarty_block_hook')) include 'C:/OpenServer/domains/cscart/app/functions/smarty_plugins\\block.hook.php';
...
<?php $_smarty_tpl->_capture_stack[0][] = array("price_".((string)$_smarty_tpl->tpl_vars['obj_id']->value), null, null); ob_start(); ?>
    <span class="<?php if ($_smarty_tpl->tpl_vars['product']->value['zero_price_action']!=="A") {?>cm-reload-<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['obj_prefix']->value, ENT_QUOTES, 'UTF-8');
echo htmlspecialchars($_smarty_tpl->tpl_vars['obj_id']->value, ENT_QUOTES, 'UTF-8');
...
$_tmp16=ob_get_clean();?><?php $_smarty_tpl->tpl_vars['label_text'] = new Smarty_variable($_tmp16." ".((string)$_smarty_tpl->tpl_vars['product']->value['discount_prc'])."%", null, 0);?>
                <?php } else { ?>
                    <?php ob_start();
echo $_smarty_tpl->__("save_discount");
$_tmp17=ob_get_clean();?><?php $_smarty_tpl->tpl_vars['label_text'] = new Smarty_variable($_tmp17." ".((string)$_smarty_tpl->tpl_vars['product']->value['list_discount_prc'])."%", null, 0);?>
                <?php }?>
...
<?php $_smarty_tpl->_capture_stack[0][] = array("product_options_".((string)$_smarty_tpl->tpl_vars['obj_id']->value), null, null); ob_start(); ?>
    ...
    <div class="cm-reload-<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['obj_prefix']->value, ENT_QUOTES, 'UTF-8');
echo htmlspecialchars($_smarty_tpl->tpl_vars['obj_id']->value, ENT_QUOTES, 'UTF-8');?>
 js-product-options-<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['obj_prefix']->value, ENT_QUOTES, 'UTF-8');
echo htmlspecialchars($_smarty_tpl->tpl_vars['obj_id']->value, ENT_QUOTES, 'UTF-8');?>
