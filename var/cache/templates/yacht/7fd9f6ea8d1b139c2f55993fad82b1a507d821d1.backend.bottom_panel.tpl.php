<?php /* Smarty version Smarty-3.1.21, created on 2020-10-26 21:43:53
         compiled from "C:\OpenServer\domains\cscart\design\backend\templates\components\bottom_panel\bottom_panel.tpl" */ ?>
<?php /*%%SmartyHeaderCode:4772920545f9718e93baa79-97050186%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '7fd9f6ea8d1b139c2f55993fad82b1a507d821d1' => 
    array (
      0 => 'C:\\OpenServer\\domains\\cscart\\design\\backend\\templates\\components\\bottom_panel\\bottom_panel.tpl',
      1 => 1598952126,
      2 => 'backend',
    ),
  ),
  'nocache_hash' => '4772920545f9718e93baa79-97050186',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5f9718e951e546_82868782',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5f9718e951e546_82868782')) {function content_5f9718e951e546_82868782($_smarty_tpl) {?><?php if (!is_callable('smarty_block_styles')) include 'C:/OpenServer/domains/cscart/app/functions/smarty_plugins\\block.styles.php';
...
"
                ...
                <?php if (fn_check_permissions("customization","update_mode","admin",'',array("type"=>"live_editor"),@constant('AREA'),$_smarty_tpl->tpl_vars['auth']->value['user_id'])&&$_smarty_tpl->tpl_vars['auth']->value['user_type']===smarty_modifier_enum("UserTypes::ADMIN")) {?>
                    <a href="<?php ob_start();
...
"
                ...
                <?php }?>
                <?php if (fn_check_permissions("customization","update_mode","admin",'',array("type"=>"theme_editor"),@constant('AREA'),$_smarty_tpl->tpl_vars['auth']->value['user_id'])&&$_smarty_tpl->tpl_vars['auth']->value['user_type']===smarty_modifier_enum("UserTypes::ADMIN")) {?>
                    <a href="<?php ob_start();
echo htmlspecialchars(urlencode($_smarty_tpl->tpl_vars['c_url']->value), ENT_QUOTES, 'UTF-8');
...
"
                ...
                <?php }?>
                <?php if (fn_check_permissions("customization","update_mode","admin",'',array("type"=>"block_manager"),@constant('AREA'),$_smarty_tpl->tpl_vars['auth']->value['user_id'])&&$_smarty_tpl->tpl_vars['auth']->value['user_type']===smarty_modifier_enum("UserTypes::ADMIN")) {?>
