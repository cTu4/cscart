<?php /* Smarty version Smarty-3.1.21, created on 2020-10-26 21:44:43
         compiled from "C:\OpenServer\domains\cscart\design\backend\templates\views\block_manager\manage.tpl" */ ?>
<?php /*%%SmartyHeaderCode:5755051185f97191b3445f0-25607751%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '07c55e9a32d0065c795cd67141e22703bdb700f4' => 
    array (
      0 => 'C:\\OpenServer\\domains\\cscart\\design\\backend\\templates\\views\\block_manager\\manage.tpl',
      1 => 1598952126,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '5755051185f97191b3445f0-25607751',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5f97191b454646_84922731',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5f97191b454646_84922731')) {function content_5f97191b454646_84922731($_smarty_tpl) {?><?php if (!is_callable('smarty_function_script')) include 'C:/OpenServer/domains/cscart/app/functions/smarty_plugins\\function.script.php';
...
<?php $_smarty_tpl->_capture_stack[0][] = array("buttons", null, null); ob_start(); ?>
    ...
    <?php if ($_smarty_tpl->tpl_vars['show_layout_controls']->value) {?>
        ...
        <?php $_smarty_tpl->_capture_stack[0][] = array("tools_list", null, null); ob_start(); ?>
            <li>
                <?php ob_start();
echo htmlspecialchars(fn_url("?s_layout=".((string)$_smarty_tpl->tpl_vars['layout_data']->value['layout_id']),"C"), ENT_QUOTES, 'UTF-8');
...
$_tmp2=ob_get_clean();?><?php echo $_smarty_tpl->getSubTemplate ("common/popupbox.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('id'=>"upate_layout_".((string)$_smarty_tpl->tpl_vars['layout_data']->value['layout_id']),'text'=>$_tmp2.": ".((string)$_smarty_tpl->tpl_vars['layout_data']->value['name']),'content'=>Smarty::$_smarty_vars['capture']['add_new_picker'],'act'=>"link",'link_text'=>$_smarty_tpl->__("properties")), 0);?>
...
$_tmp3=ob_get_clean();?><?php smarty_template_function_btn($_smarty_tpl,array('type'=>"dialog",'class'=>"cm-ajax-force hand icon-cog",'href'=>"block_manager.update_location?location=".((string)$_smarty_tpl->tpl_vars['location']->value['location_id'])."&s_layout=".((string)$_smarty_tpl->tpl_vars['location']->value['layout_id']),'id'=>"tab_location_".((string)$_smarty_tpl->tpl_vars['location']->value['location_id']),'title'=>$_tmp3.": ".((string)$_smarty_tpl->tpl_vars['tab']->value['title'])));?>
...
$_tmp4=ob_get_clean();?><?php echo $_smarty_tpl->getSubTemplate ("common/popupbox.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('id'=>"add_new_location",'text'=>$_smarty_tpl->__("block_manager.new_layout_page"),'link_text'=>$_tmp4."…",'act'=>"link",'href'=>"block_manager.update_location?s_layout=".((string)$_smarty_tpl->tpl_vars['location']->value['layout_id']),'opener_ajax_class'=>"cm-ajax",'link_class'=>"cm-ajax-force",'icon'=>"icon-plus",'content'=>''), 0);?>
</li>
        <?php }?>
    </ul>
</div>
...
$_tmp5=ob_get_clean();?><?php smarty_template_function_btn($_smarty_tpl,array('type'=>"list",'text'=>$_smarty_tpl->__("preview"),'href'=>$_tmp5,'target'=>"_blank"));?>
</li>
                                <?php if ($_smarty_tpl->tpl_vars['show_layout_controls']->value) {?>
                                    <li class="divider"></li>
...
if (!empty($_capture_buffer)) {
 ...
 Smarty::$_smarty_vars['capture'][$_capture_buffer]=ob_get_clean();
                                        ...
                                        <?php ob_start();
echo $_smarty_tpl->__("editing_layout");
$_tmp6=ob_get_clean();?><?php echo $_smarty_tpl->getSubTemplate ("common/popupbox.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('id'=>"upate_layout_".((string)$_smarty_tpl->tpl_vars['layout']->value['layout_id']),'text'=>$_tmp6.": ".((string)$_smarty_tpl->tpl_vars['layout']->value['name']),'content'=>Smarty::$_smarty_vars['capture']['add_new_picker'],'act'=>"link",'link_text'=>$_smarty_tpl->__("properties")), 0);?>
