<?php /* Smarty version Smarty-3.1.21, created on 2020-10-26 21:44:44
         compiled from "C:\OpenServer\domains\cscart\design\backend\templates\views\block_manager\render\block.tpl" */ ?>
<?php /*%%SmartyHeaderCode:8962070875f97191c162065-93912237%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'a29a9a0970e1492a930f98c132ce9e671b0f5a59' => 
    array (
      0 => 'C:\\OpenServer\\domains\\cscart\\design\\backend\\templates\\views\\block_manager\\render\\block.tpl',
      1 => 1598952126,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '8962070875f97191c162065-93912237',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5f97191c1bebf5_62398317',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5f97191c1bebf5_62398317')) {function content_5f97191c1bebf5_62398317($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_replace')) include 'C:\\OpenServer\\domains\\cscart\\app\\lib\\vendor\\smarty\\smarty\\libs\\plugins\\modifier.replace.php';
?><?php
...
if (!empty($_capture_buffer)) {
 ...
 <?php if ($_smarty_tpl->tpl_vars['status']->value!="A") {?>block-off<?php }?> <?php if ($_smarty_tpl->tpl_vars['parent_grid']->value['content_align']==constant("\Tygh\BlockManager\Grid::ALIGN_RIGHT")) {?>pull-right<?php } elseif ($_smarty_tpl->tpl_vars['parent_grid']->value['content_align']==constant("\Tygh\BlockManager\Grid::ALIGN_LEFT")) {?>pull-left<?php }?> <?php if ($_smarty_tpl->tpl_vars['external_render']->value) {?>bm-external-render<?php }?>"
...
<span class="action-switch"></span></a></li>
        ...
        <a class="cm-select-bm-block hidden" data-block-uid="<?php echo htmlspecialchars(fn_encrypt_text(((string)$_smarty_tpl->tpl_vars['block_data']->value['block_id']).":".((string)$_smarty_tpl->tpl_vars['block_data']->value['snapping_id'])), ENT_QUOTES, 'UTF-8');?>
" data-ca-block-name="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['block_data']->value['name'], ENT_QUOTES, 'UTF-8');?>
